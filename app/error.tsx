...
export default function RootError({
  ...
  useEffect(() => {
    console.error("[SERVER_RENDER_ERROR]", { route: "app", source: "RootError", error });
  }, [error]);

  const detail =
    process.env.NODE_ENV === "development" && error.message
      ? error.message
      : "We could not load this page. The site is still available — please try again or return to the homepage.";
